...
import { updateTask, deleteTaskFromFirebase } from "../store/tasksSlice"; // Correct import
...
const Modal = ({ onClose, isOpen, task, setTask }) => {
  ...
  const handleDeleteTask = (e) => {
    e.preventDefault();
    dispatch(deleteTaskFromFirebase(task.id)); // Use the correct function
    // Optionally update local storage, if needed
    localStorage.setItem(
      "tasks",
            ...
            >
              ...
              <div className="flex justify-end">
                ...
                <button
                  ...
                  className="bg-white text-purple-800 text-ls hover:border border-red-700 hover:bg-red-500 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-3 py-2 text-center me-2 mb-2 dark:border-purple-400 dark:text-purple-400 dark:hover:bg-purple-500 dark:focus:ring-purple-900"
                >
                  Delete
                </button>
              </div>
